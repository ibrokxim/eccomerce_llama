...
class UserSettingController extends Controller
{
    ...
    public function store(StoreUserSettingRequest $request)
    {
        if (auth()->user()->settings()->where('setting_id', $request->setting_id)->exists()){
            return $this->error("Настройка уже существует");
        }
        ...
        return $this->success('Настройки пользователя созданы', $userSetting);
    }
    ...
    public function update(UpdateUserSettingRequest $request, UserSetting $userSetting)
    {
        ...
        return $this->success('Настройки пользователя обновлены');
    }
    ...
    public function destroy(UserSetting $userSetting)
    {
        ...
        return $this->success('Настройки пользователя успешно удалены!');
    }
}
